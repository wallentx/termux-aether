...
| Native glibc compatibility | Full Geekbench CPU run completed as native app UID 10445 without rish/Arch; result 402547. Identity, DNS, execve and posix_spawn probes pass. Expanded PATH exec, scripts, mixed glibc/Bionic children, and system() now pass the CI-built execution probe on the development Pixel 8 Pro (`36e9fbd1`); Pixel 11 validation is pending ADB connectivity. General Linux compatibility is not claimed. |
